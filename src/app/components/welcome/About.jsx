            ...
            <Root>
                <Row className="row align-middle">
                    <div className="columns">
                        ...
                        <SubHeader>
                            Голос - это знакомство с миром криптовалют через вознаграждаемый контент и активность, а благодаря блокчейн-технологиям всё останется в веках с подтверждённым авторством и без цензуры.<br /><br />
                            Пишите, общайтесь, получайте вознаграждения от сообщества и награждайте других.
                        </SubHeader>
