import { APP_NAME, APP_DOMAIN, LANDING_PAGE_URL, LIQUID_TOKEN, DEBT_TOKEN, DEBT_TOKEN_SHORT, VESTING_TOKEN, LIQUID_TICKER } from 'app/client_config';
/**
...
const ru = {
  ...
  VESTING_TOKEN_is_non_transferrable_and_requires_convert_back_to_LIQUID_TOKEN: VESTING_TOKEN + ' нельзя передавать и потребуется 2 месяца и 8 выплат чтобы перевести обратно в ' + LIQUID_TOKEN + '.',
  // TODO
