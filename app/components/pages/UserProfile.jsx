...
export default class UserProfile extends React.Component {
    ...
    render() {
        ...
        let nftMenu = [
            {link: `/@${accountname}/nft-tokens`, label: tt('g.nft_tokens'), value: tt('g.nft_tokens'),},
            {link: `/@${accountname}/nft-collections`, label: tt('g.nft_collections'), value: tt('g.nft_collections')},
            {link: `/@${accountname}/nft-history`, label: tt('g.nft_history'), value: tt('g.nft_history'),},
        ];
